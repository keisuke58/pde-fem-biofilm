...
NOTE (2026-09-07): this file is a byte-identical copy of the git-tracked
patch_usermat_to_v222.py, restored under this alternate name because the
original filename is being actively blocked from (re)creation on this
machine -- `git checkout -- patch_usermat_to_v222.py` and even a raw
...
when Oliver sends a newer version rather than something to redo by hand.
    ...
    python patch_usermat_to_v222_restored.py Usermat_P21-V21_Conection_Test.F -o Usermat_v222.F

C     Driver: exercise the Abaqus UMAT constitutive core
C     (BIOFILM_STRESS_CORE, stress in Abaqus Voigt order 11,22,33,12,13,23).
C     Reads F(3,3), Fv(3,3), (alpha,c10,c01,d1,eta,mtype,dt) from stdin;
C     prints SV(6), Fv_new(9), detFe.  Links umat_biofilm_visco.f.
      PROGRAM XABQ

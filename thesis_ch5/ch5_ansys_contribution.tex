...
%
% PACKAGES: amsmath, amssymb, bm, xcolor, graphicx, tikz (+ the libraries the
%   figure uses). Numbers are written out rather than via siunitx so that this
%   file drops into any tree without adding a dependency.
%
...
%   easy mistake here.
%=======================================================================
\newcommand{\TierA}[1]{\marginpar{\footnotesize A}#1}   % writable now
\newcommand{\TierB}[1]{\marginpar{\footnotesize B}\textcolor{gray}{#1}} % needs runs

...
def main():
    ...
    x_data_all = jnp.load(os.fspath(base / "x_1d.npy"))
    t_all = jnp.load(os.fspath(base / "t_1d.npy"))
    u_traj = jnp.load(os.fspath(base / "u_1d_traj.npy"))
    ...
    for i in range(20):
        ...
        grads = loss_grad(params_current)
        new_params = []
    ...
    final_loss = loss_fn(params_current)
    print("JAXFEM PINN 1D reaction-diffusion")

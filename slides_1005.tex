...
\end{tabular}
\end{table}
{\scriptsize Toy law, own machine (IKMHIWI03), measured 19 Aug 2026 --- not yet
inside ANSYS/UMAT itself (ANSYS link blocked, see backup slide); native Fortran
number is a lower-bound proxy for the in-process UMAT call path.}
\end{column}
...
\begin{enumerate}
  ...
  \item Scope check: is the 2-species reduction acceptable for the thesis claims?

...
% CONSTRAINT: keep total page count <= 20 (currently 18). Check the built
% PDF's page count before adding another frame; trim an existing frame
% before growing past the cap rather than just tacking more on.
